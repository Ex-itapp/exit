...
export default function NewFlagEntry() {
  ...
  return (
    <div className="max-w-3xl mx-auto space-y-6 animate-in fade-in zoom-in-95 duration-200 min-h-[80vh] flex flex-col">
      ...
      <Card className="flex-1 flex flex-col shadow-sm border-t-4 border-t-accent/60 bg-bg">
        <CardContent className="flex-1 flex flex-col space-y-6 pt-6 p-4 md:p-8">
          ...
          <div className="flex-1 flex flex-col space-y-3">
            ...
            <Textarea 
              ...
              className="flex-1 min-h-[200px] resize-none text-lg p-4 bg-transparent border-2 border-ink/15 focus-visible:ring-0 focus-visible:shadow-sm transition-shadow"
              value={content}
          ...
          <div className="flex justify-end pt-4 border-t-2 border-ink/10">
            <Button size="lg" onClick={handleSave} disabled={!content.trim()} className="shadow-xs bg-accent hover:bg-accent/90 text-bg border-accent">
