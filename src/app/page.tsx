...
import {
  ...
  Flame, Check, Sparkles, ArrowRight, Plus, ShieldOff, Zap, TrendingUp
} from "lucide-react";
...
const RedFlagDemo = () => {
  ...
  return (
    <div className="bg-purple/20 border-4 border-ink p-5 sm:p-8 shadow-[8px_8px_0px_0px_rgba(17,17,17,1)] w-full max-w-xl mx-auto -rotate-1 relative">
      <AnimatePresence>
        {boom && (
      ...
      <div className="flex justify-between items-center mb-5">
        <h3 className="font-heading text-xl sm:text-2xl uppercase tracking-tighter">Red Flag Dropper</h3>
      ...
      <div className="flex flex-wrap gap-2 mb-4">
        {cats.map(c => (
          <button key={c} onClick={() => setCat(c)}
            className={`px-3 py-1.5 border-3 border-ink font-mono text-xs font-bold uppercase transition-all ${cat === c ? "bg-brand shadow-[3px_3px_0px_0px_rgba(17,17,17,1)] -translate-x-[1px] -translate-y-[1px]" : "bg-white hover:bg-bg"}`}>
            {c}
          </button>
        ))}
      </div>
      ...
      <textarea value={flagText} onChange={e => setFlagText(e.target.value)}
        ...
        className="w-full bg-white border-4 border-ink p-4 font-mono text-sm font-bold resize-none h-24 mb-4 focus:outline-none focus:bg-brand/10 transition-colors placeholder:text-ink/30" />
  ...
  return (
    <motion.div ref={ref} style={{ opacity, y }}
      ...
      <div className="flex-1 text-center sm:text-left">
        ...
        <h3 className="font-heading text-3xl sm:text-5xl uppercase tracking-tighter mb-4">{f.title}</h3>
    ...
    <div className="min-h-screen font-sans bg-bg overflow-x-hidden selection:bg-brand selection:text-ink">
      ...
      <nav className="fixed top-0 w-full z-50 bg-bg/80 backdrop-blur-xl border-b-4 border-ink">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 h-16 flex items-center justify-between">
          <Link href="/" className="flex items-center gap-2.5">
            ...
            <span className="font-heading text-xl tracking-tighter uppercase">EX-it.</span>
          </Link>
          ...
          <div className="flex items-center gap-3 sm:gap-5">
            ...
            <Link href="/auth"
              className="bg-brand border-4 border-ink px-4 py-2 font-heading text-sm uppercase shadow-[3px_3px_0px_0px_rgba(17,17,17,1)] hover:-translate-x-[1px] hover:-translate-y-[1px] hover:shadow-[4px_4px_0px_0px_rgba(17,17,17,1)] transition-all whitespace-nowrap">
              Start Healing
            </Link>
          </div>
        </div>
      ...
      <main>
        ...
        <section ref={heroRef} className="min-h-screen flex flex-col items-center justify-center px-4 pt-16 pb-8 text-center relative overflow-hidden">
          ...
          <motion.div style={{ y: heroY, opacity: heroOpacity }} className="relative z-10 flex flex-col items-center">
            <motion.h1
              ...
              className="font-heading text-[13vw] sm:text-7xl lg:text-[110px] tracking-tighter uppercase leading-[0.88] text-ink mb-6"
            ...
            >
              <Link href="/auth"
                className="group flex items-center justify-center gap-3 bg-ink text-white border-4 border-ink px-8 py-4 font-heading text-lg uppercase shadow-[6px_6px_0px_0px_rgba(255,51,102,1)] hover:shadow-[3px_3px_0px_0px_rgba(255,51,102,1)] hover:translate-x-[3px] hover:translate-y-[3px] transition-all">
                Start Healing <ArrowRight size={20} className="group-hover:translate-x-1 transition-transform" />
              </Link>
              <Link href="/auth"
                className="flex items-center justify-center gap-2 border-4 border-ink px-8 py-4 font-heading text-lg uppercase bg-white hover:bg-bg shadow-[4px_4px_0px_0px_rgba(17,17,17,1)] hover:shadow-[2px_2px_0px_0px_rgba(17,17,17,1)] hover:translate-x-[2px] hover:translate-y-[2px] transition-all">
                Log In
              </Link>
            </motion.div>
          </motion.div>
        ...
        <section className="px-4 sm:px-8 py-8 max-w-5xl mx-auto">
          ...
          >
            <h2 className="font-heading text-4xl sm:text-6xl uppercase tracking-tighter mb-4">Built to Break Free</h2>
        ...
        <section className="py-16 sm:py-28 px-4 bg-ink relative overflow-hidden">
          ...
          <div className="max-w-5xl mx-auto relative z-10">
            ...
            >
              <h2 className="font-heading text-4xl sm:text-6xl uppercase tracking-tighter text-white mb-4 drop-shadow-[5px_5px_0px_rgba(255,51,102,1)]">
                Try It Right Now
              </h2>
        ...
        <section className="py-16 sm:py-28 px-4">
          <div className="max-w-4xl mx-auto">
            ...
            >
              <h2 className="font-heading text-4xl sm:text-6xl uppercase tracking-tighter mb-4">Simple Pricing</h2>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 sm:gap-8 max-w-3xl mx-auto">
              ...
              >
                ...
                <Link href="/auth" className="block text-center border-4 border-ink py-3.5 font-heading text-base uppercase shadow-[4px_4px_0px_0px_rgba(17,17,17,1)] hover:bg-ink hover:text-white hover:shadow-[2px_2px_0px_0px_rgba(17,17,17,1)] hover:translate-x-[2px] hover:translate-y-[2px] transition-all">
                  Start Healing
                </Link>
              </motion.div>
              ...
              >
                ...
                <Link href="/auth" className="block text-center bg-brand text-ink border-4 border-ink py-3.5 font-heading text-base uppercase shadow-[4px_4px_0px_0px_rgba(255,51,102,1)] hover:shadow-[2px_2px_0px_0px_rgba(255,51,102,1)] hover:translate-x-[2px] hover:translate-y-[2px] transition-all">
                  Most Popular
                </Link>
              </motion.div>
            </div>
        ...
        <section className="py-24 sm:py-40 px-4 bg-positive relative overflow-hidden">
          ...
          <div className="max-w-3xl mx-auto text-center relative z-10">
            <motion.div
              ...
              transition={{ duration: 0.7, ease: [0.16, 1, 0.3, 1] }}
            >
              <h2 className="font-heading text-[11vw] sm:text-7xl md:text-8xl uppercase tracking-tighter text-ink leading-[0.88] mb-8">
                You Deserve<br />To Heal.
              </h2>
              <Link href="/auth"
                className="group inline-flex items-center gap-3 bg-ink text-white border-4 border-ink px-10 py-5 font-heading text-xl uppercase shadow-[8px_8px_0px_0px_rgba(255,255,255,0.5)] hover:shadow-[4px_4px_0px_0px_rgba(255,255,255,0.5)] hover:translate-x-[4px] hover:translate-y-[4px] transition-all">
                Start Your Era
